...
public class GuiButtonDark extends GuiButton {
    ...
    protected static final ResourceLocation background = new ResourceLocation("securemod:textures/gui/widgetsdark.png");
	
    public GuiButtonDark(int par1, int par2, int par3, String par4Str){
