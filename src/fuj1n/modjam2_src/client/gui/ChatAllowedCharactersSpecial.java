...
public class ChatAllowedCharactersSpecial {
	/**
	...
	private static String getAllowedCharacters() {
		...
		try {
			BufferedReader bufferedreader = new BufferedReader(new InputStreamReader(ChatAllowedCharactersSpecial.class.getResourceAsStream("/font.txt"), "UTF-8"));
			String s1 = "";
