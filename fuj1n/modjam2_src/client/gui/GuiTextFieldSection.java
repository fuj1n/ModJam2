...
public class GuiTextFieldSection extends Gui
{
    /**
    ...
    public GuiTextFieldSection(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5)
    {
    ...
    {
        String s1 = "";
        String s2 = ChatAllowedCharactersSpecial.filerAllowedCharacters(par1Str);
        int i = this.cursorPosition < this.selectionEnd ? this.cursorPosition : this.selectionEnd;
        int j = this.cursorPosition < this.selectionEnd ? this.selectionEnd : this.cursorPosition;
                ...
                default:
                    switch (par2)
                    {
                        ...
                        case 211:
                            ...
                            return true;
                        default:
                            if (ChatAllowedCharactersSpecial.isAllowedCharacter(par1))
                            {
