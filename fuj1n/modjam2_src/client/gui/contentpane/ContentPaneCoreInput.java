...
public class ContentPaneCoreInput extends ContentPane {
	...
	public void addButtons(List buttonList) {
		...
		addButton(buttonList, 1, 135, 68, "Pass", mode);
		addButton(buttonList, 2, 175, 68, "Card", mode);
		addButton(buttonList, 3, 215, 68, "Retina", mode);
		addButton(buttonList, 4, 255, 68, "Red", mode);
	}
